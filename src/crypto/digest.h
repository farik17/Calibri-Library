...
auto digestAlgorithm() -> const EVP_MD * { return EVP_md_null(); }

} // namespace Internal

template<DigestType Type>
auto digest(const Buffer &data) -> Buffer
{
