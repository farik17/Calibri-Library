...
auto cipher(const ByteArray &data, ByteArray &key, const ByteArray &iv = "iv") noexcept -> ByteArray
{
    ...
    EVP_EncryptUpdate(&cipherContext, reinterpret_cast<unsigned char *>(encryptedData.data()), &processedBytes, reinterpret_cast<const unsigned char *>(data.data()), data.size());
...
auto cipher(const ByteArray &data, const ByteArray &key, const ByteArray &iv = "iv") noexcept -> ByteArray
{
    ...
    EVP_DecryptUpdate(&cipherContext, reinterpret_cast<unsigned char *>(decryptedData.data()), &processedBytes, reinterpret_cast<const unsigned char *>(data.data()), data.size());
