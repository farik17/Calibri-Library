...
{
    filesystem_path_tree path_tree = filesystem_parse_path(path);
    filesystem_normalize_path_tree(path_tree);
...
int filesystem_remove_path(const c_platform_string &path)
{
    ...
    while (it != path_tree.crend()) {
        current_path = filesystem_path_tree_to_string(path_tree);
...
{
    filesystem_path_tree path_tree;
